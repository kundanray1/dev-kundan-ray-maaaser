...
const SubCampaignDonateNow = ({ navigation, data, loginData,route }) => {
  ...
  const makeDonation = (values) => {
     navigation.navigate("Sub Campaign Donate Now Confirmation",{
      ...
      transactionType:PaymentProto.TransactionType.SUB_CAMPAIGN_FUND,
...
export default SubCampaignDonateNow;
