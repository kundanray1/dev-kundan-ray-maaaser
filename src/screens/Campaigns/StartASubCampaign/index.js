...
import { startASubCampaignStart,startASubCampaignClear,startASubCampaignEditStart,startASubCampaignEditClear } from "./actions";
...
const mapDispatchToProps = (dispatch) => {
	return {
		...
		startASubCampaignEditStart: (values) => dispatch(startASubCampaignEditStart(values)),
	}
}
