...
const SubCampaignComments = ({ navigation, data,loginData, subCampaignComments,postSubCampaignComments,subCampaignId }) => {
  ...
  const onSubmitDonateConfirmation=()=>{
    ...
    commentData.setRefid(subCampaignId)
    postSubCampaignComments(commentData)
  }
        ...
        <Block style={{ flex: 0, marginTop: 6 }}>
         ...
         <Block style={{ paddingHorizontal: 18,backgroundColor:"white",justifyContent:"flex-end",bottom:0,paddingVertical:10,position:"absolute",width:"100%"}}>
           <Block style={styles.commentSection}>
              ...
              <TouchableOpacity  activeOpacity={1} style={{flex:1}} onPress={() => onSubmitDonateConfirmation()}>
                  <Text
                  center
