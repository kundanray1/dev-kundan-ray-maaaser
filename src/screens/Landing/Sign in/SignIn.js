...
const SignIn = ({ navigation, data, loginData, campaigns, campaignId, startACampaignThirdUpdateData, startACampaignThirdData }) => {
    ...
    return (
        <BwScreen header={
            ...
            body={
                <>
                    <Container   style={{flex:0.5, justifyContent:'flex-end'}}>
                        <Text bold color={theme.colors.gray} style={{ fontSize: 20, lineHeight: 30 }}>
                            Sign in to your account
                        </Text>
                        <Seperator />
                        <Text bold style={{ fontSize: 15, lineHeight: 20 }}>
                            Sign in to get access to view all the accounts,
                            donate, create campaigns and many more.    </Text>
                        <Seperator />
                        ...
                        <View>
                        <Text size={14} bold color={theme.colors.gray} weight='normal' style={{marginTop:10}} >
                        Already have an account? </Text>
                        
                        <TouchableOpacity onPress={()=>navigation.navigate("Login")} style={{flexDirection:'row', alignItems:'center'}}><Text size={14} bold color={theme.colors.primary2} middle weight='600' height={20}>Login</Text>
                        </TouchableOpacity> 
                        </View>
                    </Container>
