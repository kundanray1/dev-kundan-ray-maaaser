...
const Receivers = ({ navigation, data, loginData, campaigns, campaignId, startACampaignThirdUpdateData, startACampaignThirdData }) => {
                        ...
                        <FlatList
                            ...
                            renderItem={({ item }) =>
                                <RowNoPadding >
                                    ...
                                    <Text bold color={theme.colors.primary2} weight="600" height={19}>
                                            Donate
                                        </Text>
                                </RowNoPadding>
