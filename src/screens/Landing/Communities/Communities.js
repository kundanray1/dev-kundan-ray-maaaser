...
import { Card, CardText, CardTitle, ColCard, Container, HeaderText, IconBackground, Row, RowNoPadding, Seperator, TextClick, UserIconPlace } from "../../../utility/styledComponents.js";
...
const Communities = ({ navigation, data, loginData, campaigns, campaignId, startACampaignThirdUpdateData, startACampaignThirdData }) => {
                ...
                <>
                    <Block style={{ paddingHorizontal: 20 }}>
                        ...
                        <FlatList
                            ...
                            renderItem={({ item }) =>
                                <RowNoPadding >
                                    <IconBackground style={{ backgroundColor: theme.colors.white, elevation: 2, }}>
                                        <Image source={communityIcon} style={{ width: 30, height: 30,}} />
                                    </IconBackground>
                                    <Block>
                                        ...
                                        <Block style={{ flexDirection: 'row' }}>
                                            <View style={{ width: '15%', backgroundColor: '#E9F9FF', padding: 5, margin: 2, alignSelf: 'flex-start' }}>
                                                <Text bold center weight="400" size={10} height={10} >
                                                    Mandir
                                                </Text>
                                            </View>
                                            <View style={{ width: '15%', backgroundColor: '#E9F9FF', padding: 5, margin: 2, alignSelf: 'flex-start' }}>
