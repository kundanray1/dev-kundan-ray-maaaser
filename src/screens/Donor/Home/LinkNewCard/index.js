...
import { linkNewCardStart,linkNewCardClear,updateLinkNewCardStart,updateLinkNewCardClear } from "./actions";
...
const mapDispatchToProps = (dispatch) => {
	return {
		...
		updateLinkNewCardClear: () => dispatch(updateLinkNewCardClear()),
	}
}
