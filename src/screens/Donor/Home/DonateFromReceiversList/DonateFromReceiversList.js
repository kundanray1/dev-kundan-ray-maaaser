...
const DonateFromReceiversList = ({
  ...
  const makeDonation = (values) => {
      navigation.navigate("Donate From Receivers List Confirmation", {
        accountid: loginData.user.account.accountid,
        receiverId: route.params.accountid,
        receiverName: route.params.fullname,
...
export default DonateFromReceiversList;
